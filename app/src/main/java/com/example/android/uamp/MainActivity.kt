...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        viewModel.navigateToFragment.observe(this, Observer {
            it?.getContentIfNotHandled()?.let { fragmentRequest ->
                ...
                //Log.e(TAG, "viewModel.navigateToFragment")
                transaction.replace(
        ...
        viewModel.rootMediaId.observe(this,
            Observer<String> { rootMediaId ->
                rootMediaId?.let {
                    ...
                    //Log.e(TAG, "viewModel.rootMediaId.observe")
                }
            })
    ...
    private fun navigateToMediaItem(mediaId: String) {
        var fragment: MediaItemFragment? =
            supportFragmentManager.findFragmentByTag(mediaId) as MediaItemFragment?
        if (fragment == null) {
        ...
        //Log.e(TAG, "navigateToMediaItem: ${!isRootId(mediaId)}", )
    }
